...
public class DriveOnHeadingCommand extends TccCommandBase {
    ...
    public void execute() {
        ...
        double leftSpeed  = speed + error * DriveConstants.GYRO_PID_KP;
        double rightSpeed = speed - error * DriveConstants.GYRO_PID_KP;
    ...
    public boolean isFinished() {
        ...
        // Check the timeout
        if ((System.currentTimeMillis() - commandStartTimeMillis) / 1000d > timeoutSeconds) {
